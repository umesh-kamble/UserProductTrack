...
namespace ProductDelivery.Effects
{
    public static class LineColorEffect
    {
        ...
        {
            public EntryLineColorEffect() : base("ProductDelivery.EntryLineColorEffect")
            {
            }
        }
        ...
        {
            public DatePickerLineColorEffect() : base("ProductDelivery.DatePickerLineColorEffect")
            {
            }
        }
        ...
        {
            public PickerLineColorEffect() : base("ProductDelivery.PickerLineColorEffect")
            {
            }
        }
    }
